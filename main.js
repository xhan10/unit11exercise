...
//4a
console.log("Hello, My name is Xiaonan Han")
...
//7b
console.log("The type of '43.221' is " + typeof(43.221));
...
//7h
console.log("The type of 'ture' is " + typeof(true));

//7i
console.log("The type of 'Ture' is " + typeof(Ture));
...
//8a
var total=  console.log ("foo plus bar"  + (2+3));

//8a
var total=  console.log ("foo times bar"  + (2*3));

//8a
var total=  console.log ("total divided bar"  + (6/3));

//8a
var total=  console.log ("square of total"  + (5*5));
//8a
